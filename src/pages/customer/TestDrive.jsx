...
const TestDrive = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setIsSubmitted(true);
    // In a real app, send to API then clear
    setTimeout(() => {
      clearTestDrives();
    }, 5000); // Clear after 5 seconds so they can see it first
  };
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <AnimatePresence>
                  {testDriveCars.map((storedCar) => {
                    const car = mockData.cars.find(c => c.id === storedCar.id) || storedCar;
                    return (
                      <motion.div
                        key={car.id}
                        layout
              ...
              <CardContent className="p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select 
                        ...
                        className="w-full bg-charcoal-800 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white focus:outline-none focus:ring-2 focus:ring-accent-red"
                      >
                        <option value="downtown">Downtown Showroom (Main St.)</option>
                        <option value="uptown">Uptown Dealership (Park Ave.)</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <Button 
                    ...
                    className="w-full" 
                    size="lg"
                    disabled={testDriveCars.length === 0}
                  >
                    Confirm Booking
                  </Button>
                </form>
